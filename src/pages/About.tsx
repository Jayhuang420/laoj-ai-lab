...
const DEFAULTS = {
  intro: {
    ...
    headline: '從零售業高管\n到靠 AI 音樂頻道領被動收入',
    bio: [
      '我是操盤管理 12 間門市的零售高管。但真正讓我做出「睡覺也在累積收入」的，不是管理經驗——而是一個我不露臉、不唱歌、連樂理都不懂也能經營的 YouTube 音樂頻道。',
  ...
  timeline: {
    items: [
      { year: '2011–2018', title: '零售業高階管理', description: '從門市主管一路晉升至區域總監，操盤管理 12 間門市、帶領門市團隊，磨出選品與看數據的實戰直覺。' },
      { year: '2018–2022', title: '電商暨品牌數位轉型', description: '主導集團電商業務從零打造，整合 O2O 策略，帶動整體業績年成長 40%+。' },
      { year: '2022–2025', title: '白天上班，晚上做 AI 副業', description: '部落格、短影音都試過卻沒起色；直到 2025 把「AI 音樂 ＋ 不露臉頻道」組合起來，才跑出第一個真正會賺錢的模型。' },
      { year: '2025–Now', title: '音樂頻道教學 & 老 J AI 實驗室', description: '養出唯夏 VXYA、ChillNight 等營利頻道並開課教學，第一批 4 月學員最快一個多月就開通 YouTube 營利。' },
    ],
  },
};
