...
import { BarChart3, Users, Wrench, Home, FileText, PenSquare, Settings, LogOut, Lock, MessageSquare } from 'lucide-react';
...
const tabs = [
  ...
  { id: 'inquiries', label: '諮詢管理', icon: <MessageSquare className="w-4 h-4" /> },
...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <SEO title="後台管理" path="/admin" noindex />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <AnimatePresence mode="wait">
          <div key={activeTab}>
            ...
            {activeTab === 'inquiries' && <InquiriesTab api={api} />}
